...
var GetDataFromUserService = /*#__PURE__*/function () {
  ...
  return _createClass(GetDataFromUserService, [{
    ...
    value: function () {
      var _InsertUserDataToProfile = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var userIdLinks, _t4;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              return this.GetUserById(window.authManager.userData.userId).then(function (user) {
                ...
                var firstNameElements = document.querySelectorAll('[data-user-firstname]');
                var lastNameElements = document.querySelectorAll('[data-user-lastname]');
